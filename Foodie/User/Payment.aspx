                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Name must be in characters" ControlToValidate="txtName" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[a-zA-Z\s]+$" ValidationGroup="card">*</asp:RegularExpressionValidator>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                ...
                                                ValidationExpression="[0-9]{16}" ControlToValidate="txtCardNo" ValidationGroup="card">*</asp:RegularExpressionValidator>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Expiry month is"
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic"
                                                        ...
                                                        ValidationExpression="[0-9]{2}" ControlToValidate="txtExpMonth" ValidationGroup="card"></asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="rfvExpYear" runat="server" ErrorMessage="Expiry years must be "
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic"
                                                        ...
                                                        ValidationExpression="[0-9]{4}" ControlToValidate="txtExpYear" ValidationGroup="card"></asp:RegularExpressionValidator>
                                                    <div class="input-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic"
                                                        ...
                                                        ValidationExpression="[0-9]{3}" ControlToValidate="txtCvv" ValidationGroup="card">*</asp:RegularExpressionValidator>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Address is required" ForeColor="Red"
                                                ControlToValidate="txtAddress" Display="Dynamic" SetFocusOnError="true" ValidationGroup="card"></asp:RequiredFieldValidator>
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group ">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCODAddress" runat="server" ErrorMessage="Address is required"
                                            ForeColor="Red" ControlToValidate="txtCODAddress" Display="Dynamic" SetFocusOnError="true" ValidationGroup="cod"
                                    ...
                                    <p class="text-muted">
                                        Note: At the of recieving you order, you need to do full payment.
